...
public class JsonUtils {
     ...
     * @param nullskip 是否跳过<code>null</code>值属性,默认为不跳过
     * @return JSON字符串
     * @see com.springboot.tutorial.demo01.util.JsonUtils#toJson(Object, DateFormat, boolean, boolean, Class, String...)
     */
     ...
     * @param dateFormat 时间格式,默认格式为<tt>yyyy-MM-dd HH:mm:ss,SSS</tt>,默认时区为GMT+8
     * @return JSON字符串
     * @see com.springboot.tutorial.demo01.util.JsonUtils#toJson(Object, DateFormat, boolean)
     */
     ...
     * @param value 被序列化的对象
     * @return JSON字符串
     * @see com.springboot.tutorial.demo01.util.JsonUtils#toJson(Object, DateFormat)
     */
     ...
     * @param javaType JAVA对象类型
     * @return 指定类型的JAVA对象
     * @see com.springboot.tutorial.demo01.util.JsonUtils#toBean(String, Class, DateFormat)
     */
